    ...
    "passives": [
      {
        ...
        "summary": "During the Growth phase — Gain Income step, gain 25% more 🪙 gold (rounded up).",
    ...
    "passives": [
      {
        ...
        "summary": "During the Growth phase — Gain Income step, gain 50% less 🪙 gold (rounded up).\nSkip Growth phase.\nSkip War Recovery step during Upkeep phase.",
    ...
    "passives": [
      {
        ...
        "summary": "During the Growth phase — Gain Income step, gain 50% more 🪙 gold (rounded up).\nBuild action costs 20% less 🪙 gold (rounded up).\nGain +20% 📈 Growth.",
    ...
    "passives": [
      {
        ...
        "summary": "During the Growth phase — Gain Income step, gain 25% less 🪙 gold (rounded up).\nSkip Growth phase.",
