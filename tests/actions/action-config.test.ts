...
import { createEngine, runDevelopment, performAction, Resource, EngineContext, createActionRegistry } from '../../src/engine';
...
describe('Action configuration overrides', () => {
  it('respects modified expand costs and effects', () => {
    ...
    expand.effects = [
      ...
      { type: 'resource', method: 'add', params: { key: Resource.happiness, amount: 5 } },
    ];
