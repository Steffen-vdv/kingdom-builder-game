...
import { costModParams, developmentTarget, resultModParams, resourceAddEffect, effect } from './builders';
...
export const growthBonusEffect = (amount: number) => resourceAddEffect(GROWTH_RESOURCE_KEY, amount);
