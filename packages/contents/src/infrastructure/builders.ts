...
import { ActionBuilder, ActionCategoryBuilder, BaseBuilder, BuildingBuilder, DevelopmentBuilder, InfoBuilder, PopulationBuilder } from './builders/domain';
...
export { ActionBuilder, ActionCategoryBuilder, BaseBuilder, BuildingBuilder, DevelopmentBuilder, InfoBuilder, PopulationBuilder };
...
export function resourceAssignmentPassiveId(resourceId: ResourceKey) {
	return `${resourceId}_$player_$index`;
}
...
class WinConditionBuilder {
	...
	displayIcon(icon: string) {
		this.displayConfig = { ...this.displayConfig, icon };
		return this;
	}

	displayVictory(text: string) {
		this.displayConfig = { ...this.displayConfig, victory: text };
		return this;
	}

	displayDefeat(text: string) {
		this.displayConfig = { ...this.displayConfig, defeat: text };
		return this;
	}
