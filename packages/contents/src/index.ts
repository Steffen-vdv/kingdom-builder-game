...
export { RESOURCE_V2, RESOURCE_GROUPS_V2, createResourceGroupRegistry, createResourceV2Registry, type ResourceV2GroupRegistry, type ResourceV2Registry } from './resourceV2';
