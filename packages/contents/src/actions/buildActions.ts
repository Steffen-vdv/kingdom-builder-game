...
export function registerBuildActions(registry: Registry<ActionDef>) {
	...
	registry.add(
		...
		action()
			...
			.effect(effect(Types.Building, BuildingMethods.ADD).params(buildingParams().id(BuildingId.TownCharter)).build())
	...
	registry.add(
		...
		action()
			...
			.name(mill.name)
			.icon(mill.icon)
			.effect(effect(Types.Building, BuildingMethods.ADD).params(buildingParams().id(BuildingId.Mill)).build())
			.category(ActionCategory.Build)
	...
	registry.add(
		...
		action()
			...
			.effect(effect(Types.Building, BuildingMethods.ADD).params(buildingParams().id(BuildingId.RaidersGuild)).build())
			.category(ActionCategory.Build)
	...
	registry.add(
		...
		action()
			...
			.effect(effect(Types.Building, BuildingMethods.ADD).params(buildingParams().id(BuildingId.PlowWorkshop)).build())
			.category(ActionCategory.Build)
	...
	registry.add(
		...
		action()
			...
			.name(market.name)
			.icon(market.icon)
			.effect(effect(Types.Building, BuildingMethods.ADD).params(buildingParams().id(BuildingId.Market)).build())
			.category(ActionCategory.Build)
	...
	registry.add(
		...
		action()
			...
			.name(barracks.name)
			.icon(barracks.icon)
			.effect(effect(Types.Building, BuildingMethods.ADD).params(buildingParams().id(BuildingId.Barracks)).build())
			.category(ActionCategory.Build)
	...
	registry.add(
		...
		action()
			...
			.name(citadel.name)
			.icon(citadel.icon)
			.effect(effect(Types.Building, BuildingMethods.ADD).params(buildingParams().id(BuildingId.Citadel)).build())
			.category(ActionCategory.Build)
	...
	registry.add(
		...
		action()
			...
			.effect(effect(Types.Building, BuildingMethods.ADD).params(buildingParams().id(BuildingId.CastleWalls)).build())
			.category(ActionCategory.Build)
	...
	registry.add(
		...
		action()
			...
			.effect(effect(Types.Building, BuildingMethods.ADD).params(buildingParams().id(BuildingId.CastleGardens)).build())
			.category(ActionCategory.Build)
	...
	registry.add(
		...
		action()
			...
			.name(temple.name)
			.icon(temple.icon)
			.effect(effect(Types.Building, BuildingMethods.ADD).params(buildingParams().id(BuildingId.Temple)).build())
			.category(ActionCategory.Build)
	...
	registry.add(
		...
		action()
			...
			.name(palace.name)
			.icon(palace.icon)
			.effect(effect(Types.Building, BuildingMethods.ADD).params(buildingParams().id(BuildingId.Palace)).build())
			.category(ActionCategory.Build)
	...
	registry.add(
		...
		action()
			...
			.name(greatHall.name)
			.icon(greatHall.icon)
			.effect(effect(Types.Building, BuildingMethods.ADD).params(buildingParams().id(BuildingId.GreatHall)).build())
			.category(ActionCategory.Build)
