...
export function registerHireActions(registry: Registry<ActionDef>) {
                ...
                action()
                        ...
                        .effect(
                                effect(Types.Population, PopulationMethods.ADD)
                                        .params(populationParams().role(PopulationRole.Council))
                                        .build(),
                        )
                        .effect(
        ...
        registry.add(
                ...
                action()
                        ...
                        .effect(
                                effect(Types.Population, PopulationMethods.ADD)
                                        .params(populationParams().role(PopulationRole.Legion))
                                        .build(),
                        )
                        .effect(
                                effect(Types.Resource, ResourceMethods.ADD)
        ...
        registry.add(
                ...
                action()
                        ...
                        .effect(
                                effect(Types.Population, PopulationMethods.ADD)
                                        .params(populationParams().role(PopulationRole.Fortifier))
                                        .build(),
                        )
                        .effect(
                                effect(Types.Resource, ResourceMethods.ADD)
