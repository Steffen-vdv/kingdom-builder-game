        ...
        const royalDecreeDevelopGroup = actionEffectGroup('royal_decree_develop')
                ...
                .option(
                        actionEffectGroupOption('royal_decree_house')
                                ...
                                .params(
                                        actionEffectGroupOptionParams()
                                                .actionId(DevelopActionId.develop_house)
                                                .developmentId(DevelopmentId.House)
                                                .landId('$landId'),
                                ),
                )
                .option(
                        actionEffectGroupOption('royal_decree_farm')
                                ...
                                .params(
                                        actionEffectGroupOptionParams()
                                                .actionId(DevelopActionId.develop_farm)
                                                .developmentId(DevelopmentId.Farm)
                                                .landId('$landId'),
                                ),
                )
                .option(
                        actionEffectGroupOption('royal_decree_outpost')
                                ...
                                .params(
                                        actionEffectGroupOptionParams()
                                                .actionId(DevelopActionId.develop_outpost)
                                                .developmentId(DevelopmentId.Outpost)
                                                .landId('$landId'),
                                ),
                )
                .option(
                        actionEffectGroupOption('royal_decree_watchtower')
                                ...
                                .params(
                                        actionEffectGroupOptionParams()
                                                .actionId(DevelopActionId.develop_watchtower)
                                                .developmentId(DevelopmentId.Watchtower)
                                                .landId('$landId'),
                                ),
                );
