...
export function createResourceGroupRegistry(
	definitions: readonly ResourceGroupDefinition[],
): ResourceGroupRegistry {
	return createOrderedRegistry('Resource group', definitions);
}

export type ResourceCategoryRegistry =
	OrderedRegistry<ResourceCategoryDefinition>;

export function createResourceCategoryRegistry(
	definitions: readonly ResourceCategoryDefinition[],
