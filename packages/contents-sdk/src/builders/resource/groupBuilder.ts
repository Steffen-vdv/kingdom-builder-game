...
type ParentMetadata = Pick<
	ResourceGroupParent,
	'id' | 'label' | 'icon' | 'description' | 'lowerBound' | 'upperBound'
>;
...
export interface ResourceGroupBuilder {
	/** Display label for the group (falls back to parent.label) */
	label(label: string): this;
	/** Display icon for the group (falls back to parent.icon) */
