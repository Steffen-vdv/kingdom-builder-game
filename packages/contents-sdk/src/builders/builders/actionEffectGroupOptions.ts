...
/**
 * Generic development ID parameter.
 * Games can narrow this type by intersecting with their own DevelopmentId type.
 */
export type DevelopmentIdParam = string;

/**
 * Generic action ID parameter.
 * Games can narrow this type by intersecting with their own ActionId type.
 */
export type ActionIdParam = string;
