...
export const GENERAL_CORE_RESOURCE_INFO = {
	icon: GENERAL_CORE_RESOURCE_ICON,
	label: 'Core Resources',
	description:
		'Core resources capture enduring strengths and capacities for your kingdom. They shift when effects adjust long-term capabilities, and their history tracks notable peaks even after values return to zero.',
};
