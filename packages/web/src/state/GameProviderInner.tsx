...
import { useTranslationBootstrap } from './useTranslationBootstrap';
...
export function GameProviderInner({
	...
	const { translationContext, shouldRenderFallback } = useTranslationBootstrap({
		sessionState,
		registries,
		ruleSnapshot,
		sessionMetadata,
	...
	const resolvedTranslationContext = translationContext!;
	...
	const value: LegacyGameEngineContextValue = {
		...
		cachedSessionSnapshot,
		selectors,
		translationContext: resolvedTranslationContext,
		ruleSnapshot,
		log,
		logOverflowed,
		resolution,
