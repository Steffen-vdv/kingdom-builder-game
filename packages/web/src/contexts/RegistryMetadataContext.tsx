...
export interface RegistryMetadataContextValue {
	...
	overviewContent: SessionOverviewContent | null;
}
...
export function RegistryMetadataProvider({
	...
	const overviewContent = useMemo<SessionOverviewContent | null>(
		() => metadata.overviewContent ?? null,
		[metadata],
	);
...
export const useOverviewContent = (): SessionOverviewContent | null =>
