...
import type { SimulateUpcomingPhasesOptions } from '@kingdom-builder/protocol/session';
import type { GameApi } from '../../../src/services/gameApi';
import { RemoteSessionAdapter } from '../../../src/state/remoteSessionAdapter';
import { selectSessionView } from '../../../src/state/sessionSelectors';
import type { GameEngineRequests } from '../../../src/state/GameContext.types';
...
export function createActionsPanelGame({
	...
	const { requests: baseRequests, ...state } = baseState;
	const requests = {
		...baseRequests,
		hasAiController: (playerId: string) => session.hasAiController(playerId),
		readActionMetadata: (actionId: string, params?: ActionParametersPayload) =>
