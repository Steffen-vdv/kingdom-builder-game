...
describe('useActionPerformer', () => {
	...
	it('reports fatal session errors when mirroring fails', async () => {
		const mirroringError = new SessionMirroringError('Desync', {});
		performSessionActionMock.mockRejectedValueOnce(mirroringError);
