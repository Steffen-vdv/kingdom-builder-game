...
describe('GameProvider', () => {
	...
	beforeEach(() => {
		...
		createTranslationContextMock.mockReturnValue({});
...
it('shows the fatal screen when translation bootstrap fails', async () => {
		const fatalError = new Error('translation failed');
