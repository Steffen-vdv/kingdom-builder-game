...
| -------------------- | -------------------- | ---------------------------------------------------- |
| No approval file     | QA didn't complete   | "Re-run QA review (Step 2 in docs/push-workflow.md)" |
| Invalid signature    | Approval corrupted   | "Re-run QA review (Step 2 in docs/push-workflow.md)" |
